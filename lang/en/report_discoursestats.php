...
$string['invalidentgmethod'] = 'Invalid engagement calculation method.';
...
$string['privacy:metadata:core_grades'] = 'Grade records for students are written to the Moodle gradebook by this plugin.';
$string['privacy:metadata:discoursestats_grading_log'] = 'Grade push audit log entries for users graded by this plugin.';
$string['privacy:metadata:discoursestats_grading_log:feedback'] = 'The feedback string pushed to the gradebook for this user.';
$string['privacy:metadata:discoursestats_grading_log:rawgrade'] = 'The numeric grade pushed to the gradebook for this user.';
$string['privacy:metadata:discoursestats_grading_log:userid'] = 'The ID of the student who received the grade.';
